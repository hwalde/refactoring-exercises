...
class TestUserManager:
    ...
    def test_create_user_with_custom_roles(self):
        ...
        user = self.user_manager.create_user('admin', 'admin@example.com', 'Password123', ['admin'])
    ...
    def test_create_user_with_duplicate_username(self):
        ...
        with pytest.raises(ValueError, match='Username already exists'):
            self.user_manager.create_user('testuser', 'test2@example.com', 'Password123')
    ...
    def test_create_user_with_invalid_password_format(self):
        ...
        with pytest.raises(ValueError, match='Password must contain uppercase, lowercase, and numbers'):
    ...
    def test_create_user_with_invalid_role(self):
        ...
        with pytest.raises(ValueError, match='Invalid role: invalid'):
            self.user_manager.create_user('testuser', 'test@example.com', 'Password123', ['invalid'])

    def test_update_user_username(self):
        """Test updating user username."""
        user = self.user_manager.create_user('testuser', 'test@example.com', 'Password123')
        
        updated_user = self.user_manager.update_user(user.id, {'username': 'newusername'})
    ...
    def test_update_user_email(self):
        ...
        updated_user = self.user_manager.update_user(user.id, {'email': 'newemail@example.com'})
    ...
    def test_get_all_users(self):
        ...
        user1 = self.user_manager.create_user('user1', 'user1@example.com', 'Password123')
        user2 = self.user_manager.create_user('user2', 'user2@example.com', 'Password123')
    ...
    def test_complete_user_workflow(self):
        ...
        # Update user
        updated_user = self.user_manager.update_user(user.id, {'username': 'updateduser'})
