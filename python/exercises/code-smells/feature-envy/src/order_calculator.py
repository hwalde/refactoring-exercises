...
class OrderCalculator:
    ...
    def calculate_shipping_cost(self, order: Order) -> float:
        ...
        # Base shipping cost
        base_rate = self.shipping_rates['express'] if is_express else self.shipping_rates['standard']
        ...
        for item in items:
            ...
            product_shipping_cost = self.calculate_product_shipping_cost(product, quantity)
    ...
    def requires_special_handling(self, product: Product) -> bool:
        ...
        """
        return (product.is_fragile() or 
                product.get_weight() > 20.0 or 
                product.get_category() == 'electronics')
