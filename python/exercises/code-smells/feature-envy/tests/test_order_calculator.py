...
class TestOrderCalculator:
    def setup_method(self):
        ...
        self.standard_customer = Customer(
            "1", "John Doe", "john@example.com", "standard", 1
        )
        self.premium_customer = Customer(
            "2", "Jane Smith", "jane@example.com", "premium", 3
        )
        ...
        self.electronics = Product(
            "phone1", "Smartphone", 699.99, "electronics", 0.2, True
        )
        self.furniture = Product(
            "chair1", "Office Chair", 199.99, "furniture", 15.0, False
        )
    ...
    def test_calculate_customer_discount_for_standard_loyal_customer(self):
        ...
        loyal_customer = Customer(
            "4", "Loyal Customer", "loyal@example.com", "standard", 5
        )
    ...
    def test_calculate_order_subtotal(self):
        ...
        items = [OrderItem(self.book, 2), OrderItem(self.electronics, 1)]
    ...
    def test_calculate_order_weight(self):
        ...
        items = [OrderItem(self.book, 2), OrderItem(self.furniture, 1)]
        order = Order("1", self.standard_customer, items, "Address")
    ...
    def test_requires_special_handling_for_fragile_product(self):
        ...
        requires_special_handling = self.calculator.requires_special_handling(
            self.electronics
        )
    ...
    def test_has_special_handling_items(self):
        ...
        items = [OrderItem(self.book, 1), OrderItem(self.electronics, 1)]  # fragile
        order = Order("1", self.standard_customer, items, "Address")
    ...
    def test_get_customer_priority_level_for_loyal_standard(self):
        ...
        loyal_customer = Customer(
            "5", "Loyal Standard", "loyal@example.com", "standard", 5
        )
        order = Order("1", loyal_customer, [], "Address")
